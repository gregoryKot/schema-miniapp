    ...
    items: [
      {
        ...
        desc: 'Подчиняется ожиданиям других («замри» — капитуляция перед схемой). Подавляет собственные нужды ради сохранения отношений или избегания наказания. Копинг через сдачу.',
      },
      {
...
const MODE_CHECKIN = [
  ...
  { emoji: '😄', label: 'Легко и радостно', mode: 'Счастливый Ребёнок', tip: 'Ты в ресурсном режиме! Запомни это ощущение — к нему можно возвращаться. Это и есть ощущение удовлетворённых базовых потребностей.' },
