...
const QUESTIONS: string[] = [
  ...
  'В основном мне не на кого было опереться — ни за советом, ни за поддержкой.',
  ...
  'Моя потребность в людях настолько велика, что страх их потерять постоянно присутствует.',
  ...
  'Среди других мне бывает неловко — мои достижения явно уступают их.',
  ...
  'Мир представляется мне опасным и небезопасным.',
  ...
  'Ради избегания открытого конфликта я готов сделать значительно больше, чем большинство.',
  ...
  'Выражать свои чувства перед другими для меня дискомфортно.',
  ...
  'Я ставлю себе задачу быть первым по результатам и продуктивности.',
  ...
  'Даже понимая, что это нужно, я не могу вынудить себя делать то, что мне неприятно.',
  ...
  'Моё внимание автоматически фиксируется на плохом, а не на хорошем.',
  ...
  'В глубине я считаю себя плохим человеком, заслуживающим кары.',
