        ...
        <div style={{ padding: '8px 24px 48px', overflowY: 'auto' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.7)', lineHeight: 1.7 }}>
              Этот дневник помогает замечать свои потребности и отслеживать паттерны. Советы — ориентировочные: они не заменяют работу с психологом.
              <br /><br />
              Если что-то беспокоит по-настоящему, лучший шаг — поговорить со специалистом. Только в терапии можно разобраться что именно происходит и почему.
            </div>
          </div>
