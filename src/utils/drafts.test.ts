...
describe('saveDraft / loadDraft', () => {
  it('сохраняет и читает черновик с полем data', () => {
  ...
  it('возвращает null при битом JSON в хранилище', () => {
...
describe('formatDraftAge', () => {
  ...
  it('склонение часов: 1 час / 2 часа / 5 часов', () => {
  ...
  it('склонение дней: 1 день / 2 дня / 5 дней', () => {
